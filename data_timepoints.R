...
# This script recall cell count data and set our database
...
# first step: get carrying capacity (K) of total population
df_hacat$repli <- NULL
df_sk147$repli <- NULL
...
# second step: get the density of cell necessary to reach K namely E
E1 = as.numeric(K1 - (df_hacat[1,] + df_sk147[1,]))
E2 = as.numeric(K2 - (df_hacat[2,] + df_sk147[2,]))
E3 = as.numeric(K3 - (df_hacat[3,] + df_sk147[3,]))

#Step 3: convert E in a data frame and make a csv file
