...
library('ggplot2')
# Load data
path = "C:/R-4.2.2/dataAnalysis_UFRN/BooleanNetworkBioME/booleanKinetics/heatmapCsv/hipo2"
setwd(path)
filesName <- "C:/R-4.2.2/dataAnalysis_UFRN/BooleanNetworkBioME/booleanKinetics/heatmapCsv/hipo2/matrix7.csv"
...
tiff("nghDens_8_h2.tiff", width = 6, height = 3.7, units = 'in', res = 300)
pheatmap(
...
#ggsave(filename=paste0("hacatDensity8.png"),plot = p2)


# # Plot hacat local density of hacat
# p1 <- pheatmap((local_density_hacat > 0.95)*1 , #local_density,
#                 color = colorRampPalette(c('blue','yellow'))(256),#gray(seq(0,1, length.out=256)),
#                 cluster_rows = F, cluster_cols = F,
#                 show_rownames = F, show_colnames = F,
#                 height = 10,
#                 width = 10)
#   
# ggsave(filename=paste0("ngh_matrix7.png"),plot = p1)
